...
\begin{itemize}
    ...
    \end{equation}
    onde $P$ é o conjunto de pares contrafactuais, $o_i$ e $o_j$ são os outputs correspondentes, e $\theta_{sim} = 0.80$ é o limiar de similaridade semântica, consistente com valores empíricos de \textit{Counterfactual Cosine Similarity}~\cite{Bouchard2026}.
